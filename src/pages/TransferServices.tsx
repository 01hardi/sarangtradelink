    ...
    <Layout>
      <div className="py-12 bg-travel-navy text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center max-w-3xl mx-auto text-lg text-gray-200">
            Travel seamlessly to and from London's major airports with Addison Lee. We provide reliable, premium and comfortable transfers to Heathrow, Gatwick, Luton, Stansted, and London City airports.
          </p>
        </div>
      </div>
      <VehicleSelector />
      ...
      <BookingSection 
        ...
        subtitle="Whether you're catching a flight for business or leisure, our professional drivers and premium vehicles ensure a smooth journey every time."
      />
    </Layout>
  );
};

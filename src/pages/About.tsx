    ...
    <Layout>
      ...
      <div className="relative bg-travel-navy py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl md:text-5xl font-playfair font-bold text-white mb-4">About Us</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                ...
                What began as a small tour guide service has grown into a comprehensive travel agency specializing in 
                creating personalized London experiences.
              </p>
              <p className="text-gray-600 mb-6">
                Our team of experienced locals knows every corner of this magnificent city, from the iconic landmarks to 
                the hidden gems that don't make it into standard tour guides. We pride ourselves on our attention to detail, 
                personalized service, and commitment to making your London visit truly special.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <div className="bg-travel-light-gray p-6 rounded-lg flex-1 text-center">
                  <h3 className="text-travel-gold text-4xl font-bold mb-2">10+</h3>
                  <p className="text-travel-navy font-medium">Years of Experience</p>
                </div>
                <div className="bg-travel-light-gray p-6 rounded-lg flex-1 text-center">
                  <h3 className="text-travel-gold text-4xl font-bold mb-2">5000+</h3>
                  <p className="text-travel-navy font-medium">Happy Customers</p>
                </div>
                <div className="bg-travel-light-gray p-6 rounded-lg flex-1 text-center">
                  <h3 className="text-travel-gold text-4xl font-bold mb-2">25+</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Our guides are London natives who know the city inside out, sharing authentic insights and stories.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-16 h-16 bg-travel-gold/10 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">We tailor each experience to your preferences, ensuring you get exactly what you want from your visit.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-16 h-16 bg-travel-gold/10 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">We believe in experiences that connect you with local culture, not just ticking off tourist attractions.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-16 h-16 bg-travel-gold/10 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">We're committed to responsible travel practices that respect London's heritage and environment.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="text-center">
              <div className="relative mb-4 overflow-hidden rounded-lg group">
                <img src="/images/team-1.jpg" alt="Team Member" className="w-full h-auto transition-transform duration-500 group-hover:scale-110" />
            ...
            <div className="text-center">
              <div className="relative mb-4 overflow-hidden rounded-lg group">
                <img src="/images/team-2.jpg" alt="Team Member" className="w-full h-auto transition-transform duration-500 group-hover:scale-110" />
                <div className="absolute inset-0 bg-travel-navy/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="flex space-x-3">
                    <a href="#" className="text-white hover:text-travel-gold">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="text-center">
              <div className="relative mb-4 overflow-hidden rounded-lg group">
                <img src="/images/team-3.jpg" alt="Team Member" className="w-full h-auto transition-transform duration-500 group-hover:scale-110" />
                <div className="absolute inset-0 bg-travel-navy/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="flex space-x-3">
                    <a href="#" className="text-white hover:text-travel-gold">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="text-center">
              <div className="relative mb-4 overflow-hidden rounded-lg group">
                <img src="/images/team-4.jpg" alt="Team Member" className="w-full h-auto transition-transform duration-500 group-hover:scale-110" />
                <div className="absolute inset-0 bg-travel-navy/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="flex space-x-3">
                    <a href="#" className="text-white hover:text-travel-gold">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">

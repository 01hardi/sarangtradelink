...
import { 
  MapPin, Phone, Mail, Clock, Facebook, Instagram, Twitter, Youtube, ArrowRight 
} from 'lucide-react';
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex">
                ...
                <span className="text-gray-300">123 Westminster, London, UK SW1A 1AA</span>
              </li>
              <li className="flex">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 text-sm text-gray-400">
              ...
              <Link to="/terms-conditions" className="hover:text-travel-gold transition-colors">
                Terms & Conditions
              </Link>
              <Link to="/faq" className="hover:text-travel-gold transition-colors">
                FAQ
              </Link>
            </div>
          </div>
